...
// Ajouter les contrôles de première personne ici, par exemple avec PointerLockControls
...
// Positionner la caméra et régler les contrôles
...
// Centrer sur les chaises volantes


// Positionner et orienter chaque caméra
cameraFirstPerson.position.set(100,-50, 150); // Exemple de position pour la vue de première personne

cameraOrbitalGeneral.position.set(150, 0, 200); // Haute et vue d'ensemble
controlsOrbitalGeneral.target.set(100, 20, 100); // Cibler le centre du parc

cameraOrbitalRollerCoaster.position.set(50, 50, 50); // Vue sur la montagne russe
controlsOrbitalRollerCoaster.target.set(10, 0, 10); // Ajustez en fonction de la position de la montagne russe

// Ajoutez chaque caméra à votre tableau de caméras
cameras.push(cameraFirstPerson,cameraOrbitalGeneral,cameraOrbitalFlyingChairs);
...
function animate() {
    ...
    renderer.render(scene_manege, cameras[activeCameraIndex]);
}
