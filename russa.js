...
// Faire la forme de le surface de la montagne russe
shape.moveTo(0, 0);
shape.lineTo(10, 0);
shape.lineTo(10, -10);
...
// pour avoir les points de la courbe
...
// on crée un objet de la courbe plus simple pour pouvoir la bouger apres
...
// BUG : le but reprendre les points une fois qu'on a bougé le tube, apres si on arrive pas a régler on peut juste modife directe la courbe
...
for (const point of newPoints) {
  //on ajoute des cylindre tous les 15 points
  ...
  // AMELIORATION : rotate la shape selon la pente de la courbe
